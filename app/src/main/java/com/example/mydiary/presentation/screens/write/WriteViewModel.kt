...
import com.example.mydiary.core.data.database.ImageToDeleteDao
import com.example.mydiary.core.data.database.ImageToUploadDao
...
import com.example.mydiary.utils.extensions.isNotNull
    ...
    fun deleteDiary(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            uiState.selectedDiaryId?.let {
                ...
                if (result is RequestState.Success) {
                    withContext(Dispatchers.Main) {
                        uiState.selectedDiary?.let { diary ->
                            deleteImagesFromFirebase(images = diary.images)
                        }
                        onSuccess()
                    }
                } else if (result is RequestState.Error) {
